...
def action_wrapper(action_int):
    ...
    """
    # We force the agent to take 1 step forward in every action
    act = {
        "forward": 1,
        "back": 0, 
        "left": 0, 
    ...
    if action_int == 0:
        ...
        # Rotate the POV horizontally in one direction
        act['camera'] = [0, 10]
    elif action_int  == 2:
        # Rotate the POV horizontally in the other direction
        act['camera'] = [0, -10]
